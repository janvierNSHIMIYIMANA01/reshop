...
if (isset($_POST['update'])) {
    $id = $_POST['id'];
    $date = $_POST['date'];
    // Repeat the following lines for other fields (p_name, p_number, price, quantity, payment)

    $sql = "UPDATE add_product SET date='$date' WHERE id=$id"; // Update other fields as well
...
if (isset($_GET['edit'])) {
    ...
    $sql = "SELECT id, date, p_name, p_number, price, quantity, payment FROM add_product WHERE id = $id";
       ...
       <a href="categorydash.php">
        ...
        <script>
         ...
         // Redirect to another page if needed: window.location.href = "logout.html";
           ...
           window.location.href = "allprdct.php";
            }
         }        
        </script>
    </div>
             ...
             <tr>
              ...
              <?php
               ...
               if ($conn->connect_error) 
                ...
                $sql = "UPDATE add_product SET date='$date', p_name='$p_name', p_number='$p_number', price='$price', quantity='$quantity', payment='$payment' WHERE id=$id";
                ...
                <td>" . $row["payment"] . "</td>
                <td>
                <a href='edit prduct frm db.php?id=" . $row["id"] . "'>Edit</a>
                </td>
                <td>
