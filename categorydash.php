        ...
        <!-------------End of insight--------------->
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST['add'])) {
                    ...
                    $sql = "INSERT INTO category (name, date) VALUES ('$name', '$date')";
                    $conn->query($sql);
                    ...
                    $sql = "UPDATE category SET name='$name', date='$date' WHERE catid=$categoryId";
                    $conn->query($sql);
            ...
            $sql = "SELECT catid, name, date FROM category";
                ...
                <table>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" style="display: inline-block;">
                                        ...
                                        <input type="text" name="name" placeholder="New name" required style="font-size: 20px; width: 150px;">
                                        <input type="date" name="date" required style="font-size: 20px; width: 150px;">
                        ...
                        <tr>
                            <td>
                                <form method="POST" style="display: inline-block;">
                                    <input type="text" name="name" placeholder="Name" style="font-size: 20px; width: 150px;" required> 
                            </td>
                            <td> 
                                <input type="date" name="date" style="font-size: 20px; width: 150px;" required>
                            </td>
                            <td>
                                <button type="submit" name="add" style="font-size: 20px; width: 150px;">Add</button>
                            </td>
                            </form>
                        </tr>
                    </tbody>
