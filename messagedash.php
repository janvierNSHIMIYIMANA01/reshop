    ...
    <div class="sidebar">
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
                <a href="adminreg.php" class="dropdown-item">Sign In</a>
                <a href="adminlog.php" class="dropdown-item">Sign Up</a>
            </div>
        </div>
    </div>
...
function logout() {
  ...
  if (result) {
    ...
    window.location.href = "messagedash.php";
  }
}        </script>
    </div>
    </aside>
    ...
    <main>
        ...
        <table>
            ...
            <?php
                ...
                echo "<table>";
                echo "<tr><th>Email</th><th>Message</th><th>Date</th></tr>";
